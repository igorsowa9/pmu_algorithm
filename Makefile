...
noinst_PROGRAMS = AIn$(EXEEXT) AInScan$(EXEEXT) \
	...
	TIn$(EXEEXT) RemoteNetDiscovery$(EXEEXT)
subdir = examples
...
am_RemoteNetDiscovery_OBJECTS = RemoteNetDiscovery.$(OBJEXT)
RemoteNetDiscovery_OBJECTS = $(am_RemoteNetDiscovery_OBJECTS)
RemoteNetDiscovery_LDADD = $(LDADD)
RemoteNetDiscovery_DEPENDENCIES = ../src/libuldaq.la
...
SOURCES = $(AIn_SOURCES) $(AInScan_SOURCES) $(AInScanIepe_SOURCES) \
	...
	$(RemoteNetDiscovery_SOURCES) $(TIn_SOURCES) \
	$(TmrPulseOut_SOURCES)
DIST_SOURCES = $(AIn_SOURCES) $(AInScan_SOURCES) \
	...
	$(DaqOutScan_SOURCES) $(RemoteNetDiscovery_SOURCES) \
...
ACLOCAL = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/missing autoconf
AUTOHEADER = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/missing autoheader
AUTOMAKE = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/missing automake-1.14
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
STRIP = strip
VERSION = 1.2.0
abs_builddir = /home/pi/n5geh/libuldaq-1.2.0/examples
abs_srcdir = /home/pi/n5geh/libuldaq-1.2.0/examples
abs_top_builddir = /home/pi/n5geh/libuldaq-1.2.0
abs_top_srcdir = /home/pi/n5geh/libuldaq-1.2.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/pi/n5geh/libuldaq-1.2.0/install-sh
...
RemoteNetDiscovery$(EXEEXT): $(RemoteNetDiscovery_OBJECTS) $(RemoteNetDiscovery_DEPENDENCIES) $(EXTRA_RemoteNetDiscovery_DEPENDENCIES) 
	@rm -f RemoteNetDiscovery$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(RemoteNetDiscovery_OBJECTS) $(RemoteNetDiscovery_LDADD) $(LIBS)
...
include ./$(DEPDIR)/RemoteNetDiscovery.Po
